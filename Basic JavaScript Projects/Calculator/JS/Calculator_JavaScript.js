...
const Calculator = {
    ...
    First_Operand: null,
    //this checks whether or not the second operand has been inputed.
...
function Input_Decimal(dot) {
    //this ensures that accisdental clicking of the decimal point
    // doesn't cause bugs in your operation
    if (Calculator.Wait_Second_Operand === true) return;
    if (!Calculator.Display_Value.inches(dot)) {
